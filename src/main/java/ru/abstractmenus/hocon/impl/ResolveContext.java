...
import ru.abstractmenus.hocon.ConfigResolveOptions;
import ru.abstractmenus.hocon.impl.AbstractConfigValue.NotPossibleToResolve;
...
final class ResolveContext {
    ...
    ResolveContext(ConfigResolveOptions options, Path restrictToChild) {
        // LinkedLinkedHashSet keeps the traversal order which is at least useful
